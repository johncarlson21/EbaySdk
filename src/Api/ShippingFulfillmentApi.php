...
class ShippingFulfillmentApi
{
     ...
     * @return object
     */
    public function createShippingFulfillment($body, $contentType, $orderId)
    {
        list($response) = $this->createShippingFulfillmentWithHttpInfo($body, $contentType, $orderId);
        return $response;
    }
     ...
     */
    public function createShippingFulfillmentWithHttpInfo($body, $contentType, $orderId)
    {
        $returnType = 'object';
        $request = $this->createShippingFulfillmentRequest($body, $contentType, $orderId);
     ...
     */
    public function createShippingFulfillmentAsync($body, $contentType, $orderId)
    {
        return $this->createShippingFulfillmentAsyncWithHttpInfo($body, $contentType, $orderId)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createShippingFulfillmentAsyncWithHttpInfo($body, $contentType, $orderId)
    {
        $returnType = 'object';
        $request = $this->createShippingFulfillmentRequest($body, $contentType, $orderId);
     ...
     */
    protected function createShippingFulfillmentRequest($body, $contentType, $orderId)
    {
        ...
        if ($contentType === null || (is_array($contentType) && count($contentType) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $contentType when calling createShippingFulfillment'
            );
        }
     ...
     *
     * @param  string $fulfillmentId The unique identifier of the fulfillment. This eBay-generated value was created by the &lt;b&gt;Create Shipping Fulfillment&lt;/b&gt; call, and returned by the &lt;b&gt;getShippingFulfillments&lt;/b&gt; call in the &lt;b&gt;fulfillments.fulfillmentId&lt;/b&gt; field; for example, &lt;code&gt;9405509699937003457459&lt;/code&gt;. (required)
     * @param  string $orderId The unique identifier of the order. Order ID values are shown in My eBay/Seller Hub, and are also returned by the &lt;b&gt;getOrders&lt;/b&gt; method in the &lt;b&gt;orders.orderId&lt;/b&gt; field. (required)
     *
     * @throws \Johncarlson21\EbaySdk\ApiException on non-2xx response
     * @throws \InvalidArgumentException
