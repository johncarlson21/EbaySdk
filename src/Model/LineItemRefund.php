...
class LineItemRefund implements ModelInterface, ArrayAccess
{
     ...
     * Sets refundId
     *
     * @param string $refundId Unique identifier of a refund that was initiated for an order's line item through the <b>issueRefund</b> method. If the <b>issueRefund</b> method was used to issue a refund at the order level, this identifier is returned at the order level instead (<b>paymentSummary.refunds.refundId</b> field).<br><br> A <b>refundId</b> value is returned in the response of the <b>issueRefund</b> method, and this same value will be returned in the <b>getOrder</b> and <b>getOrders</b> responses for pending and completed refunds.
     *
     * @return $this
     */
     ...
     *
     * @param string $refundReferenceId This field is reserved for internal or future use.
     *
     * @return $this
     */
