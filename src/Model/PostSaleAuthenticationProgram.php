...
class PostSaleAuthenticationProgram implements ModelInterface, ArrayAccess
{
    ...
    protected static $setters = [
        'outcomeReason' => 'setOutcomeReason',
        'status' => 'setStatus'
    ];
    ...
    {
        $this->container['outcomeReason'] = isset($data['outcomeReason']) ? $data['outcomeReason'] : null;
    ...
    {
        return $this->container['outcomeReason'];
    }
    ...
    {
        $this->container['outcomeReason'] = $outcomeReason;
